...
from biana_networkx.generators.classic import empty_graph, path_graph, complete_graph
...
def random_powerlaw_tree(n, gamma=3, seed=None, tries=100):
    ...
    """
    from biana_networkx.generators.degree_seq import degree_sequence_tree
    try:
